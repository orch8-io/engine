...
export const SELF_MANAGED_SUITES: readonly SelfManagedSuite[] = [
  ...
  { file: "features/principals_key_management.test.ts", reason: "needs ORCH8_API_KEY + ORCH8_ALLOW_NO_TENANT_ISOLATION at boot" },
  { file: "features/principals_worker.test.ts", reason: "needs ORCH8_API_KEY + ORCH8_ALLOW_NO_TENANT_ISOLATION at boot" },
  { file: "features/principals_device.test.ts", reason: "needs ORCH8_API_KEY + ORCH8_MOBILE_SYNC_ENABLED at boot" },
  { file: "features/principals_publisher.test.ts", reason: "needs ORCH8_API_KEY + ORCH8_ALLOW_NO_TENANT_ISOLATION at boot" },
  { file: "features/principals_approver.test.ts", reason: "needs ORCH8_API_KEY + ORCH8_ALLOW_NO_TENANT_ISOLATION at boot" },
  { file: "features/principals_auditor.test.ts", reason: "needs ORCH8_API_KEY + ORCH8_ALLOW_NO_TENANT_ISOLATION at boot" },
  { file: "features/principals_operator.test.ts", reason: "needs ORCH8_API_KEY + ORCH8_ALLOW_NO_TENANT_ISOLATION at boot" },
  { file: "features/mobilesync_commands_sync.test.ts", reason: "needs ORCH8_MOBILE_SYNC_ENABLED=true at boot" },
  { file: "features/mobilesync_devices_runtime.test.ts", reason: "needs ORCH8_MOBILE_SYNC_ENABLED=true at boot" },
  { file: "features/mobilesync_telemetry.test.ts", reason: "deliberately runs WITHOUT ORCH8_MOBILE_SYNC_ENABLED (telemetry routes are always mounted)" },
  { file: "features/pushwake_outbox_persistence.test.ts", reason: "needs ORCH8_MOBILE_SYNC_ENABLED=true at boot" },
  { file: "features/pushwake_outbox_lifecycle.test.ts", reason: "needs ORCH8_MOBILE_SYNC_ENABLED=true at boot" },
  { file: "features/pushwake_tenant_isolation.test.ts", reason: "needs ORCH8_MOBILE_SYNC_ENABLED=true at boot" },
