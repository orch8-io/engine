...
pub(crate) use lifecycle::{
    ...
    __path_get_instance_children, __path_get_instance_logs, __path_list_instances,
    __path_resume_from_block, __path_retry_instance, __path_update_context, __path_update_state,
    create_instance, create_instances_batch, get_instance, get_instance_children,
    get_instance_logs, list_instances, resume_from_block, retry_instance, update_context,
    update_state,
};
