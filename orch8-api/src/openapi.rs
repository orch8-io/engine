...
#[openapi(
    ...
    paths(
        ...
        crate::prompts::delete_prompt_label,
        // Tenant budgets
        crate::budgets::create_budget,
        crate::budgets::update_budget,
    ...
    components(schemas(
        ...
        // Prompt registry / budgets
        orch8_types::ai::PromptMessage,
        orch8_types::ai::PromptTemplate,
        orch8_types::ai::PromptLabel,
        orch8_types::ai::PromptCanary,
        orch8_types::ai::PromptResolution,
        orch8_types::ai::TenantBudget,
        orch8_types::ai::BudgetPeriod,
        orch8_types::ai::BudgetState,
        orch8_types::ai::BudgetStatus,
        orch8_types::ai::BudgetAlert,
        crate::prompts::PushPromptRequest,
        crate::prompts::PushPromptResponse,
        crate::prompts::PromptSummary,
