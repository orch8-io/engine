...
passthrough_impl! {
    impl crate::ContinuityStore for EncryptingStorage {
        ...
        async fn find_unresolved_effect_receipt(&self, tenant_id: &orch8_types::ids::TenantId, continuity_id: orch8_types::continuity::ContinuityId, instance_id: orch8_types::ids::InstanceId, block_id: &orch8_types::ids::BlockId, attempt: u32) -> Result<Option<orch8_types::continuity::EffectReceipt>, StorageError>;
        async fn delete_effect_receipts_for_blocks(&self, tenant_id: &orch8_types::ids::TenantId, instance_id: orch8_types::ids::InstanceId, block_ids: &[orch8_types::ids::BlockId]) -> Result<u64, StorageError>;
...
passthrough_impl! {
    impl crate::AttentionStore for EncryptingStorage {
        ...
        async fn reassign_expired_attention_task(&self, expected: &orch8_types::continuity_advanced::AttentionTask, assigned: &orch8_types::continuity_advanced::AttentionTask, now: chrono::DateTime<chrono::Utc>) -> Result<bool, StorageError>;
        async fn decide_attention_task(&self, expected: &orch8_types::continuity_advanced::AttentionTask, decided: &orch8_types::continuity_advanced::AttentionTask, now: chrono::DateTime<chrono::Utc>) -> Result<bool, StorageError>;
